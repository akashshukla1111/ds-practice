...
import static com.collection.practicejava.redmart.SpreadsheetHelper.*;
...
public class SpreadsheetImpl {
	...
	private double recurRefOrValue(SpreadResult[][] spreadsheets, String cellVal) {
		if (isReference(cellVal)) {
			String[] splits = splitLetterDigits(cellVal);
